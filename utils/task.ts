...
export type NodePre = (undefined | null | Node)[];

export type NodeNext = NodePre;

export type PriorityTimeoutParams = { [PRIORITY_TYPE.HIGH]?: number, [PRIORITY_TYPE.NORMAL]?: number, [PRIORITY_TYPE.LOW]?: number }